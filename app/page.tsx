    ...
    <div className="bg-slate-950">
      ...
      >
        <div className="flex flex-row justify-center items-center mb-8">
          <a href="https://www.linkedin.com/in/yashyr7/" className="mx-4">
            <Image src="/linkedin.svg" alt={""} width={40} height={50}></Image>
          </a>
          <a href="https://github.com/yashyr7">
            <Image src="/github.svg" width={40} height={50} alt={""}></Image>
          </a>
        </div>
        <div
